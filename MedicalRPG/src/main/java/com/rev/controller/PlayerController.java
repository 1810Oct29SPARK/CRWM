...
public class PlayerController {
	...
	/*
	 * When a request is made this will return a list of players ordered by high
	 * score
	 */
	...
	/*
	 * When a user sends a new username, password, firstname and lastname this
	 * method will take them and the user will be added to the database as well as
	 * being returned to the profile page If any of this information is null however
	 * it will return the user to the login page
	 */
	...
	/*
	 * This is a post request that will update the players information based on
	 * their inputs if any of the information is null it will return users to the
	 * login page Once the method has added the new information in the database it
	 * will return the user to the proper profile page
	 */
	...
	/*
	 * This is a put request that will update the player in the database with a new
	 * score The information sent will be the player username and the score First
	 * the method will take find the player by their username then it will set the
	 * new score
	 */
	...
	/*
	 * This method will take in a player username then delete it If the username is
	 * incorrect the mehtod will return you to the login If the information is
	 * correct the method will return you to login after deleting the player
	 */
	...
	/*
	 * This post method will find a player by their username then return thier
	 * information
	 */
